...
fun manipulateString(str: String, int: Int): String {
    val stringList= str.toMutableList().map { it.toString() }
    val stringText = stringList.take(8).joinToString("")
    val stringNumber =stringList.drop(8).joinToString("")

    var calculate = 0
    val result = when {
        stringNumber.isNotEmpty() && stringNumber.isNotEmpty() -> {
            calculate = (stringNumber.toInt() * int)
